        ...
        <section className='container mx-auto px-4 py-12'>
                ...
                {data.map(meal => (
                    <div key={meal._id} className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col justify-between">
                        ...
                        <div className="p-6 flex flex-col flex-grow">
                            <h2 className="text-2xl font-bold text-gray-800 mb-1 group-hover:text-orange-600 transition-colors line-clamp-1" title={meal.foodName}>
                                {meal.foodName}
                            </h2>

                            {/* Chef Info */}
                            <div className="flex items-center gap-2 mb-4">
                                <div className="h-8 w-8 rounded-full bg-orange-100 flex items-center justify-center text-xs font-bold text-orange-600 border border-orange-200 uppercase">
                            ...
                            <div className="mb-6">
                                <div className="flex items-center gap-2 text-sm bg-orange-50 p-2 rounded-lg border border-orange-100">
                                    ...
                                    <span className='font-bold text-gray-800 uppercase text-[11px] tracking-tight'>
                            ...
                            <div className="mt-auto">
                                <button
                                    ...
                                    className="w-full relative overflow-hidden bg-gray-900 text-white font-semibold py-3 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 group/btn"
                                >
            ...
            {data.length === 0 && !loading && (
                <div className="text-center py-20">
                    <p className="text-gray-400 text-lg italic">No meals available at the moment.</p>
                </div>
            )}
        </section>
    );
